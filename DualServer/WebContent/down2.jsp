...
<html>
    <head>
        <title>Download Details | Page</title>
    ...
    <body>
            ...
            <div class="container">
                <div class="h_menu4"><!-- start h_menu4 -->
                    ...
                    <ul class="nav">
                        ...
                        <li><a href="req2.jsp">User Request</a></li>
                        <li class="active"><a href="down2.jsp">Download Details</a></li>
        ...
        <div class="main">
            <div class="container">
                <!-- start content-top -->
                <br><br><center><h2 style="font-size: 26px; color: #00AEFF; font-family: cursive">Download Details</h2>
                    <br><table border="2" style="text-align: center; margin-left: 0px; border-color: black">
                        <tr>
                            ...
                            <th style="text-align: center;width: 400px;  font-size: 16px; color: brown">User Name</th>
