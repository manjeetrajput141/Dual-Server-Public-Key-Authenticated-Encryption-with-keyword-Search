...
<html>
    ...
    <body>
        ...
        <div class="main">
            <div class="container">
                <!-- start content-top -->
                <br><br><center><h2 style="font-size: 26px; color: #00AEFF; font-family: cursive">File List</h2>
                    <br><table border="2" style="text-align: center; margin-left: 0px; border-color: black">
                        ...
                        <tr>
                            <%
                                String verify = (String) session.getAttribute("secret_key1");
                                System.out.println("verify Key:" + verify);
                                Connection con = null;
                                Statement st = null;
                                ResultSet rs = null;
                                try {
                                    ...
                                    rs = st.executeQuery("select * from ser where skey = '" + verify + "'");
                                    while (rs.next()) {
                            %>
                            ...
                            <td> <a href="Download?<%=rs.getString("id")%>"><font style="color: #249578">Click</a></font> </td>
                        </tr>
                        <%
