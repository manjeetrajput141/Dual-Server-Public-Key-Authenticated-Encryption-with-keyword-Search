...
<html>
    ...
    <body>
            ...
            <div class="container">
                <div class="h_menu4"><!-- start h_menu4 -->
                    ...
                    <ul class="nav">
                        ...
                        <li class="active"><a href="receive.jsp">Receive file</a></li>
        ...
        <div class="main">
            <div class="container">
                <!-- start content-top -->
                <br><br><center><h2 style="font-size: 26px; color: #00AEFF; font-family: cursive">Received File Details</h2>
                    <br><table border="2" style="text-align: center; margin-left: 0px; border-color: black">
                        <tr>
                            ...
                            <th style="text-align: center;width: 400px;  font-size: 16px; color: brown">Sender</th>
                        ...
                        <tr>
                            <%
                                ...
                                try {
                                    ...
                                    rs = st.executeQuery("select * from ser where receicer='" + user + "'");
                                    while (rs.next()) {
                            %>
                            <td style="font-size: 16px"><br><%=rs.getString("id")%></td>  
                            <td style="font-size: 16px"><br><%=rs.getString("filename")%></td>   
                            <td style="font-size: 16px"><br><%=rs.getString("sent_name")%></td>  
