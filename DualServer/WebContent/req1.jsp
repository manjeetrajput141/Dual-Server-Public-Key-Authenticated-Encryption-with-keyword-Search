...
<html>
    <head>
        ...
        %>
        <script>alert('Server1 Secret Key Sent to User Mail');</script>
        <%            }
        %>
        <!-- grid-slider -->
            ...
            <div class="container">
                <div class="h_menu4"><!-- start h_menu4 -->
                    ...
                    <ul class="nav">
                        ...
                        <li class="active"><a href="req1.jsp">User Request</a></li>
                        ...
                        <tr>
                            <%
                                ...
                                try {
                                    ...
                                    rs = st.executeQuery("select * from request where ser1='No'");
                                    while (rs.next()) {
                            %>
                            ...
                            <td> <a href="UMail.jsp?<%=rs.getString("id")%>"><font style="color: #249578">Send</a></font> </td> 
                        </tr>
                        <%
