...
<html>
    <head>
        ...
        %>
        <script>alert('Server2 Secret Key Sent to User Mail');</script>
        <%            }
        %>
        <!-- grid-slider -->
    ...
    <body>
        ...
        <div class="menu" id="menu">
            <div class="container">
                <div class="h_menu4"><!-- start h_menu4 -->
                    ...
                    <ul class="nav">
                        <li><a href="server_home.jsp">Server2 Home</a></li>
                        <li><a href="file_de2.jsp">File Details</a></li>
                        <li><a href="user_de2.jsp">User Details</a></li>
                        <li class="active"><a href="req2.jsp">User Request</a></li>
                        <li><a href="down2.jsp">Download Details</a></li>
        ...
        <div class="main">
            <div class="container">
                <!-- start content-top -->
                <br><br><center><h2 style="font-size: 26px; color: #00AEFF; font-family: cursive">Request of User</h2>
                    <br><table border="2" style="text-align: center; margin-left: 0px; border-color: black">
                        <tr>
                            ...
                            <th style="text-align: center;width: 400px;  font-size: 16px; color: brown">Country</th>
                            <th style="text-align: center;width: 200px;  font-size: 16px; color: brown">File Name</th>
                            <th style="text-align: center;width: 400px;  font-size: 16px; color: brown">Response</th>
                        ...
                        <tr>
                            <%
                                ...
                                try {
                                    ...
                                    rs = st.executeQuery("select * from request where ser2='No'");
                                    while (rs.next()) {
                            %>
                            <td style="font-size: 16px"><%=rs.getString("user_name")%></td>  
                            ...
                            <td> <a href="UMail1.jsp?<%=rs.getString("id")%>"><font style="color: #249578">Send</a></font> </td> 
                        </tr>
                        <%
