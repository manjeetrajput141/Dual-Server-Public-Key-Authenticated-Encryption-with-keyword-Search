    ...
    <body>
            ...
            <div class="container">
                <div class="h_menu4"><!-- start h_menu4 -->
                    ...
                    <ul class="nav">
                        ...
                        <li class="active"><a href="search.jsp">Search file</a></li>
        ...
        <div class="main">
            <div class="container">
                <!-- start content-top -->
                <center><br><br>
                    <img src="images/sear.jpg"  height="240" width="600">
                </center>
                <br><center><form action="search1.jsp" method="get"> 
                        <input type="text" class="inputs" name="name" required="" placeholder="Give Encrypted Keyword" /><br> 
