...
<html>
    <head>
        ...
        %>
        <script>alert('File Uploaded to Dual Server');</script>
        <%            }
        %>
        <!-- grid-slider -->
    ...
    <body>
            ...
            <div class="container">
                <div class="h_menu4"><!-- start h_menu4 -->
                    ...
                    <ul class="nav">
                        ...
                        <li class="active"><a href="share.jsp">Share File</a></li>
        ...
        <div class="main">
            <div class="container">
                <!-- start content-top -->
                <center><br>
                    <img src="images/file_share1.jpg"  height="200" width="600">
                </center>
                <br><center><form action="Upload"  method="post" enctype="multipart/form-data"> 
                        ...
                        <input type="text" class="inputs" name="keyword" required="" placeholder="File Keyword" /><br>
                        <%
                        ...
                        %>
                        <input type="text" class="inputs" name="buplic" readonly="" Value="<%=key%>" /><br>
