		...
		<div class="container">
			...
			<center>
				...
				<table border="2"
					...
					<tr>
						<th
							style="text-align: center; width: 200px; font-size: 16px; color: brown">Data File ID
							</th>
						<th
							style="text-align: center; width: 200px; font-size: 16px; color: brown">Data Owner Name</th>
						<th
							style="text-align: center; width: 200px; font-size: 16px; color: brown">Date Receiver Name
							</th>
						
						<th
							style="text-align: center; width: 400px; font-size: 16px; color: brown"> File Status</th>
						<th
