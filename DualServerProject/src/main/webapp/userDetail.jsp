		...
		<div class="container">
			...
			<center>
				...
				<table border="2"
					...
					<tr>
						<th
							style="text-align: center; width: 200px; font-size: 16px; color: brown">User
							Name</th>
						<th
							style="text-align: center; width: 200px; font-size: 16px; color: brown">Email</th>
						<th
							style="text-align: center; width: 200px; font-size: 16px; color: brown">Date
							Of Birth</th>
						<th
							style="text-align: center; width: 400px; font-size: 16px; color: brown">Gender</th>
						<th
							style="text-align: center; width: 200px; font-size: 16px; color: brown">Role</th>
						<th
							style="text-align: center; width: 400px; font-size: 16px; color: brown">Status</th>
						<th
					...
					<tr>
						...
						<td style="font-size: 16px"><%=rs.getString("role")%></td>
